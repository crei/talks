...
\begin{frame}{Next Tasks}
  \begin{itemize}
    \item Computations on structured data
    \item How to nicely map recursive algorithms to Turing machines?
...
\begin{frame}{}
  ...
  {\footnotesize
  Slides:\\\texttt{https://crei.github.io/talks/2026\_leaning\_in\_complexity/talk.pdf}
  }
\end{frame}
